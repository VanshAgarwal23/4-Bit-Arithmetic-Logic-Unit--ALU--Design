...
HD_PWD='C:/Users/Test/Vivado_projects/4-bit ALU Design/4-bit ALU Design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source logic_unit.tcl -notrace
