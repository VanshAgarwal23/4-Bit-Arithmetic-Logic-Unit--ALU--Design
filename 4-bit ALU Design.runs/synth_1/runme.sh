...
HD_PWD='C:/Users/Test/Vivado_projects/4-bit ALU Design/4-bit ALU Design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source logic_unit.tcl
