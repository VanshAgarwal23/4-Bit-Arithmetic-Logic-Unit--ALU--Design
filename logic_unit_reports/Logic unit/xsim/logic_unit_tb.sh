...
#
# Script generated by Vivado on Tue Sep 15 21:23:20 +0530 2026
# SW Build 6511674 on Tue Jun 16 11:02:23 MDT 2026
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2026 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : logic_unit_tb.sh
...
#
# Usage        : logic_unit_tb.sh
#                logic_unit_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                logic_unit_tb.sh [-rerun]
#                logic_unit_tb.sh [-reset_run]
#                logic_unit_tb.sh [-clean]
#                logic_unit_tb.sh [-reset_log]
#                logic_unit_tb.sh [-help]
#
...
# script info
echo -e "logic_unit_tb.sh - Script generated by export_simulation (Vivado v2026.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./logic_unit_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot logic_unit_tb xil_defaultlib.logic_unit_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim logic_unit_tb -key {Behavioral:sim_1:Functional:logic_unit_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb logic_unit_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./logic_unit_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: logic_unit_tb.sh [-help]\n\
Usage: logic_unit_tb.sh [-step]\n\
Usage: logic_unit_tb.sh [-lib_map_path]\n\
Usage: logic_unit_tb.sh [-rerun]\n\
Usage: logic_unit_tb.sh [-reset_run]\n\
Usage: logic_unit_tb.sh [-clean]\n\
Usage: logic_unit_tb.sh [-reset_log]\n\
Usage: logic_unit_tb.sh [-keep_index]\n\
Usage: logic_unit_tb.sh [-noclean_files]\n\n\
